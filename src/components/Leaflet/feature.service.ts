  ...
  public getBackgrounds(t: any): Promise<View[]> {
    return new Promise((resolve: any) => {
      const styleDs = {
        ...
        value: [
          {
            valueRange: { start: 0.01, end: 1.22 * (1 / 9) },
            displayValueSuffix: ' km²',
            style: {
              color: defaultViewStyleProps.color,
              weight: defaultViewStyleProps.weight,
              fillOpacity: defaultViewStyleProps.fillOpacity,
          ...
          {
            valueRange: { start: 1.22 * (1 / 9), end: 1.22 * (2 / 9) },
            displayValueSuffix: ' km²',
            style: {
              color: defaultViewStyleProps.color,
              weight: defaultViewStyleProps.weight,
          ...
          {
            valueRange: { start: 1.22 * (2 / 9), end: 1.22 * (3 / 9) },
            displayValueSuffix: ' km²',
            style: {
              color: defaultViewStyleProps.color,
              weight: defaultViewStyleProps.weight,
          ...
          {
            valueRange: { start: 1.22 * (3 / 9), end: 1.22 * (4 / 9) },
            displayValueSuffix: ' km²',
            style: {
              color: defaultViewStyleProps.color,
              weight: defaultViewStyleProps.weight,
          ...
          {
            valueRange: { start: 1.22 * (4 / 9), end: 1.22 * (5 / 9) },
            displayValueSuffix: ' km²',
            style: {
              color: defaultViewStyleProps.color,
              weight: defaultViewStyleProps.weight,
          ...
          {
            valueRange: { start: 1.22 * (5 / 9), end: 1.22 * (6 / 9) },
            displayValueSuffix: ' km²',
            style: {
              color: defaultViewStyleProps.color,
              weight: defaultViewStyleProps.weight,
          ...
          {
            valueRange: { start: 1.22 * (6 / 9), end: 1.22 * (7 / 9) },
            displayValueSuffix: ' km²',
            style: {
              color: defaultViewStyleProps.color,
              weight: defaultViewStyleProps.weight,
          ...
          {
            valueRange: { start: 1.22 * (7 / 9), end: 1.22 * (8 / 9) },
            displayValueSuffix: ' km²',
            style: {
              color: defaultViewStyleProps.color,
              weight: defaultViewStyleProps.weight,
          ...
          {
            valueRange: { start: 1.22 * (8 / 9), end: 1.22 },
            displayValueSuffix: ' km²',
            style: {
              color: defaultViewStyleProps.color,
              weight: defaultViewStyleProps.weight,
      ...
      const resolution = t('Drawer.SideContent.background.chips.1.name');
      const views = [
        {
        ...
        },
        {
          ...
          visible: false,
          url: `${process.env.REACT_APP_TILES_BASE_URL}/{attribute}/${resolution}/{year}/{z}/{x}/{y}.png`,
          style: styleDs,
        }
      ];
